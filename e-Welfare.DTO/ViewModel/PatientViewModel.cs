...
namespace e_Welfare.DTO.ViewModel
{
    public class PatientViewModel
    {
        ...
        /// <summary>
        /// Gets or sets the MedicineList ids 
        /// </summary>
        public List<string> MedicineListIds { get; set; }

        /// <summary>
        /// Gets or sets the MedicineList 
        /// </summary>
        ...
        /// </summary>
        public List<string> MedicineSelectedIds { get; set; }

        [Required(ErrorMessage = "Please Upload File")]
        [Display(Name = "Upload File")]
        [ValidateFile]
        public HttpPostedFileBase MedReceipt { get; set; }

        /// <summary>
        /// Gets or sets the Document path
        /// </summary>
        public string MedFilePath { get; set; }
