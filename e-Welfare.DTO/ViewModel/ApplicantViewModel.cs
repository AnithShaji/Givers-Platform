   ...
   public class ApplicantViewModel
    {
        ...
        /// <summary>
        /// Gets or sets the Food List ids 
        /// </summary>
        public List<string> FoodListIds { get; set; }

        /// <summary>
        /// Gets or sets the FoodList 
        /// </summary>
        ...
        /// </summary>
        public List<string> FoodSelectedIds { get; set; }

        [Required(ErrorMessage = "Please Upload File")]
        [Display(Name = "Upload File")]
        [ValidateFile]
        public HttpPostedFileBase FoodReceipt { get; set; }
