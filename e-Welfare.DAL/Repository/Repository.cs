...
namespace e_Welfare.DAL
{
    ...
    /// The data repository
    /// </summary>
    /// <typeparam name="TEntity">an entity class (only)</typeparam>
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        /// <summary>
        /// the context
        /// </summary>
        private E_WelfareContext context;
        ...
        public Repository(E_WelfareContext context)
        {
        ...
        /// </summary>
        /// <param name="entityToUpdate">entity to update</param>
        public void UpdateSingle(TEntity entityToUpdate)
        {
            this.entitySet.Attach(entityToUpdate);
            this.context.Entry(entityToUpdate).State = EntityState.Modified;
        }
